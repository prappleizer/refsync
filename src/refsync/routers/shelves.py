...
from ..db import PaperRepository, ShelfRepository
from ..models import Paper, Shelf, ShelfCreate, ShelfUpdate
...
async def create_shelf(data: ShelfCreate, repo: ShelfRepository = Depends(get_shelf_repo)):
    """Create a new shelf."""
...
async def get_shelf(shelf_id: str, repo: ShelfRepository = Depends(get_shelf_repo)):
...
async def update_shelf(
    shelf_id: str, data: ShelfUpdate, repo: ShelfRepository = Depends(get_shelf_repo)
):
    """Update a shelf."""
...
async def delete_shelf(shelf_id: str, repo: ShelfRepository = Depends(get_shelf_repo)):
    """Delete a shelf."""
